...
class VentanaPrincipal(QMainWindow):
    ...
    def impresion(self):
        ...
        if estado_siguiente == "λ":
            ...
            if (estado_siguiente == "λ (q26 = Terminal, regreso a q0)") & (moneda_insertada == "1"):
                estado_siguiente =  "q1"
                estado = "q0"
            elif (estado_siguiente == "λ (q26 = Terminal, regreso a q0)") & (moneda_insertada == "2"):
                estado_siguiente =  "q2"
                estado = "q0"
            elif (estado_siguiente == "λ (q26 = Terminal, regreso a q0)") & (moneda_insertada == "5"):
                estado_siguiente =  "q3"
                estado = "q0"
        elif estado_siguiente == "λ (q17 = Terminal, regreso a q0)":
            if (estado_siguiente == "λ (q17 = Terminal, regreso a q0)") & (moneda_insertada == "1"):
                estado_siguiente =  "q1"
                estado = "q0"
            elif (estado_siguiente == "λ (q17 = Terminal, regreso a q0)") & (moneda_insertada == "2"):
                estado_siguiente =  "q2"
                estado = "q0"
        elif estado_siguiente == "λ (q12 = Terminal, regreso a q0)":
            if (estado_siguiente == "λ (q12 = Terminal, regreso a q0)") & (moneda_insertada == "1"):
                estado_siguiente =  "q1"
                estado = "q0"
            elif (estado_siguiente == "λ (q12 = Terminal, regreso a q0)") & (moneda_insertada == "2"):
                estado_siguiente =  "q2" 
                estado = "q0"
            elif (estado_siguiente == "λ (q12 = Terminal, regreso a q0)") & (moneda_insertada == "5"):
                estado_siguiente =  "q3" 
                estado = "q0" 
        elif estado_siguiente == "λ (q4 = Terminal, regreso a q0)":
            if (estado_siguiente == "λ (q4 = Terminal, regreso a q0)") & (moneda_insertada == "10"):
                estado_siguiente =  "q0"
                estado = "q0"
            elif (estado_siguiente == "λ (q4 = Terminal, regreso a q0)") & (moneda_insertada == "5"):
                estado_siguiente =  "q3"
                estado = "q0"
        ...
        self.estados_label.setText("Anterior: (" + estado + ") -> Actual: (" + estado_siguiente + ")")
